          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" name="kode_barang" id="kode_barang" class="form-control {{ $errors->has('kode_barang') ? 'is-invalid':'' }}" placeholder="Silahkan Masukan Kode Barang..." value="{{ old('kode_barang') }}" required>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" name="nama_barang" id="nama_barang" class="form-control {{ $errors->has('nama_barang') ? 'is-invalid':'' }}" placeholder="Silahkan Masukan Nama Barang..." value="{{ old('nama_barang') }}" required>
                <div class="invalid-feedback">
